...
imagenes_dados = [pygame.image.load(f"C:/Users/fabri/OneDrive/Desktop/Curso Juegos/Actividad JUEGO CON PYGAME - Nivel II/imagenes/dados/dado{i}.png") for i in range(1, 7)]
...
def evaluar_ronda():
    ...
    if (jugador_suma == cpu_suma and jugador_suma <= 10 and cpu_suma <= 10):
        resultado = "Empate por mismo resultado"
    else:
        if(jugador_suma > 10 and cpu_suma > 10):
            resultado = "Ambos se pasaron, ninguno ganó"
            
    if (jugador_suma > cpu_suma and jugador_suma <= 10):
        resultado = "Ganaste"
    else:
        if(cpu_suma > 10 and jugador_suma <= 10):
            resultado = "CPU se pasó, ganaste"
            
    if(cpu_suma > jugador_suma and cpu_suma <= 10):
        resultado = "CPU gana"
    else:
        if(jugador_suma > 10 and cpu_suma <= 10):
            resultado = "Te pasaste, CPU gana"
